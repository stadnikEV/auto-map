...
/******/ 		}
/******/ 		script.src = __webpack_require__.p + "" + ({"0":"common-passenger","1":"registration-passenger","2":"login-passenger","3":"bad-hash","5":"application-passenger"}[chunkId]||chunkId) + ".js";
...
var _getAllowedRouteHash = _interopRequireDefault(__webpack_require__(18));

var _isCorrectHash = _interopRequireDefault(__webpack_require__(19));
  ...
  function () {
    ...
    _createClass(Router, [{
      ...
      value: function onHashChange() {
        var currentRouteHash = this.getRouteHash();

        if (!(0, _isCorrectHash.default)({
        ...
        var allowedRouteHash = (0, _getAllowedRouteHash.default)({
          currentRouteHash: currentRouteHash,
          userStatus: this.userStatus
        });
        var isAllowedRouteHash = allowedRouteHash.some(function (route) {
          var result = currentRouteHash === route;
          return result;
        });
        ...
        _pubsubJs.default.publish('routeHashChange', {
          routeHash: currentRouteHash
        });
      }
    }, {
      key: "initRouteHash",
      value: function initRouteHash() {
        var _this = this;

        _passengerApi.default.userStatus().then(function (userStatus) {
      ...
      key: "setRouteHash",
      value: function setRouteHash(_ref) {
        var routeHash = _ref.routeHash;
        var currentRouteHash = this.getRouteHash();
        ...
        window.location.hash = "#".concat(routeHash);
      }
    }, {
      key: "setUserStatus",
...
function () {
  ...
  _createClass(BaseComponent, [{
    ...
    value: function unsubscribe() {
      ...
      var evetsNames = Object.keys(this.eventsPubSub);
      evetsNames.forEach(function (eventName) {
        _pubsubJs.default.unsubscribe(_this.eventsPubSub[eventName]);
      });
    }
  }, {
    key: "removeComponent",
    value: function removeComponent(_ref4) {
...
var _baseClassApi = _interopRequireDefault(__webpack_require__(17));
...
var initSimbiozApi = function initSimbiozApi() {
  ...
  var SimbiozApi =
  /*#__PURE__*/
  function (_BaseClassApi) {
    _inherits(SimbiozApi, _BaseClassApi);

    function SimbiozApi() {
      _classCallCheck(this, SimbiozApi);

      return _possibleConstructorReturn(this, _getPrototypeOf(SimbiozApi).apply(this, arguments));
    }

    return SimbiozApi;
  }(_baseClassApi.default);

  window.simbiozApi = new SimbiozApi();
  return window.simbiozApi;
};

var _default = initSimbiozApi();
...
var _page = _interopRequireDefault(__webpack_require__(15));
...
var _template = _interopRequireDefault(__webpack_require__(73));
...
function (_BaseComponent) {
  ...
  function Page(_ref) {
    ...
    _this.elements.page = document.querySelector('[data-component="page"]');
    _this.elements.headerContainer = _this.elements.page.querySelector('[data-element="page__header-container"]');
    _this.elements.mainContainer = _this.elements.page.querySelector('[data-element="page__main-container"]');
    _this.elements.appContainer = _this.elements.page.querySelector('[data-element="page__app-container"]');
    _this.elements.baseContainer = _this.elements.page.querySelector('[data-element="page__base-container"]');
  ...
  _createClass(Page, [{
    ...
    value: function addEvents() {
      this.eventsPubSub.hashChange = _pubsubJs.default.subscribe('routeHashChange', this.onHashChange.bind(this));
    }
  }, {
    key: "removeEvents",
    ...
    value: function onHashChange(msg, _ref2) {
      ...
      if (this.currentMainComponentName) {
        var componentName = this.currentMainComponentName;
        this.currentMainComponentName = null;

        if (componentName === 'application') {
          this.hide({
            el: this.elements.appContainer
          });
        }
      ...
      if (routeHash.search(/^application.*$/) !== -1) {
        this.show({
          el: this.elements.appContainer
        });
    ...
    value: function initApplication() {
      ...
      __webpack_require__.e/* import() */(5).then(__webpack_require__.bind(null, 58)).then(function (Module) {
        if (_router.default.getRouteHash() !== 'application') {
          return;
        }

        _this2.components.app = new Module({
          el: _this2.elements.appContainer
        });

        _this2.showMainAndHeaderContainers();

        _this2.currentMainComponentName = 'application';
      }).catch(function (err) {
        console.warn(err);
      });
    }
    ...
    value: function initLogin() {
      ...
      Promise.all/* import() */([__webpack_require__.e(0), __webpack_require__.e(2)]).then(__webpack_require__.bind(null, 74)).then(function (Module) {
        if (_router.default.getRouteHash() !== 'login') {
          return;
        }

        _this3.components.login = new Module({
          el: _this3.elements.baseContainer
        });

        _this3.showMainAndHeaderContainers();

        _this3.currentMainComponentName = 'login';
      }).catch(function (err) {
        console.warn(err);
      });
    }
  }, {
    key: "initRegistration",
    value: function initRegistration() {
      var _this4 = this;

      Promise.all/* import() */([__webpack_require__.e(0), __webpack_require__.e(1)]).then(__webpack_require__.bind(null, 75)).then(function (Module) {
        if (_router.default.getRouteHash() !== 'registration') {
          return;
        }

        _this4.components.registration = new Module({
          el: _this4.elements.baseContainer
        });

        _this4.showMainAndHeaderContainers();

        _this4.currentMainComponentName = 'registration';
      }).catch(function (err) {
        console.warn(err);
      });
    }
    ...
    key: "initBadHash",
    value: function initBadHash() {
      var _this5 = this;

      __webpack_require__.e/* import() */(3).then(__webpack_require__.bind(null, 76)).then(function (Module) {
        if (_router.default.getRouteHash() !== 'badHash') {
          return;
        }

        _this5.removeAllComponents();

        _this5.components.badHash = new Module({
          el: _this5.elements.baseContainer
        });

        _this5.showOnlyMainContainer();

        _this5.currentMainComponentName = 'badHash';
      }).catch(function (err) {
        console.warn(err);
      });
    }
  }, {
    key: "showOnlyMainContainer",
    value: function showOnlyMainContainer() {
      this.hide({
        el: this.elements.headerContainer
      });
    ...
    key: "showMainAndHeaderContainers",
    value: function showMainAndHeaderContainers() {
      this.show({
        el: this.elements.headerContainer
      });
...
/*#__PURE__*/
function () {
  function BaseClassApi() {
    _classCallCheck(this, BaseClassApi);
  }

  _createClass(BaseClassApi, [{
    key: "userStatus",
    value: function userStatus() {
      return new Promise(function (resolve, reject) {
        (0, _httpRequest.default)({
          url: 'http://localhost:8080/passenger/userStatus',
          method: 'get'
    ...
    key: "registration",
    value: function registration(_ref) {
      var userName = _ref.userName,
          email = _ref.email,
          password = _ref.password;
      return new Promise(function (resolve, reject) {
        (0, _httpRequest.default)({
          url: 'http://localhost:8080/passenger/registration',
          method: 'post',
          data: JSON.stringify({
            userName: userName,
            email: email,
    ...
    key: "putMapData",
    value: function putMapData(_ref3) {
      var data = _ref3.data;
      return new Promise(function (resolve, reject) {
        (0, _httpRequest.default)({
          url: 'http://localhost:8080/passenger/login',
...
var _default = function _default(_ref) {
  ...
  var allowedRouteHash = [];

  if (userStatus === 'login') {
    allowedRouteHash = ['application', 'badHash'];
  }

  if (userStatus === 'logout' || userStatus === 'unknown') {
    allowedRouteHash = ['login', 'registration', 'badHash'];
  }
...
var _routeHashConfig = _interopRequireDefault(__webpack_require__(20));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var _default = function _default(_ref) {
  var currentRouteHash = _ref.currentRouteHash;
  var isCorrectHash = false;

  _routeHashConfig.default.forEach(function (referenceRouteHash) {
...
exports.default = void 0;
var _default = ['', 'login', 'registration', 'application', 'badHash'];
exports.default = _default;
...
if(false) {
	module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/sass-loader/lib/loader.js??ref--4-2!./reset.scss", function() {
		var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/sass-loader/lib/loader.js??ref--4-2!./reset.scss");
...
if(false) {
	module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/sass-loader/lib/loader.js??ref--4-2!./base.scss", function() {
		var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/sass-loader/lib/loader.js??ref--4-2!./base.scss");
...
// module
exports.push([module.i, ".page {\n  z-index: 1;\n  height: 100%;\n  width: 100%; }\n  .page__header-container {\n    z-index: 3;\n    width: 100%;\n    height: 8%; }\n  .page__main-container {\n    z-index: 2;\n    width: 100%; }\n  .page__main-container_show-main {\n    height: 100%; }\n  .page__main-container_show-main-header {\n    height: 92%; }\n  .page__app-container {\n    height: 100%; }\n  .page__base-container {\n    height: 100%; }\n\n@media only screen and (max-height: 420px) {\n  .page__header-container {\n    height: 15%; }\n  .page__main-container_show-main-header {\n    height: 85%; } }\n", ""]);
...
var _logo = _interopRequireDefault(__webpack_require__(29));

var _buttonHeader = _interopRequireDefault(__webpack_require__(50));

var _template = _interopRequireDefault(__webpack_require__(55));
...
function (_BaseComponent) {
  ...
  function Header(_ref) {
    ...
    _this.elements.header = document.querySelector('[data-component="header"]');
    _this.elements.logoContainer = _this.elements.header.querySelector('[data-element="header__logo-container"]');
    _this.elements.buttonLoginContainer = _this.elements.header.querySelector('[data-element="header__button-header-login-container"]');
    _this.elements.buttonRegistrationContainer = _this.elements.header.querySelector('[data-element="header__button-header-registration-container"]');

    _this.logoInit();

    _this.addEvents();

    _this.onHashChange(null, {
      routeHash: _router.default.getRouteHash()
    });
  ...
  _createClass(Header, [{
    ...
    value: function onHashChange(msg, _ref2) {
      ...
      if (routeHash === 'application') {
        ...
        if (this.components.buttonRegistration) {
          this.removeComponent({
            componentName: 'buttonRegistration'
          });
        }
    ...
    value: function logoInit() {
      this.components.logo = new _logo.default({
        el: this.elements.logoContainer
      });
    }
  }, {
    key: "buttonLoginInit",
    value: function buttonLoginInit() {
      this.components.buttonLogin = new _buttonHeader.default({
    ...
    key: "buttonRegistrationInit",
    value: function buttonRegistrationInit() {
      this.components.buttonRegistration = new _buttonHeader.default({
    ...
    key: "backlightButtons",
    value: function backlightButtons(_ref3) {
      var routeHash = _ref3.routeHash;
...
var _passenger = _interopRequireDefault(__webpack_require__(30));

var _template = _interopRequireDefault(__webpack_require__(31));
...
function (_BaseComponent) {
  ...
  function Logo(_ref) {
    ...
    _this.elements.logo = document.querySelector('[data-component="logo"]');
    _this.elements.logoImg = _this.elements.logo.querySelector('[data-element="logo__img"]');
  ...
  _createClass(Logo, [{
    ...
    value: function addEvents() {
      ...
      this.elements.logoImg.ondragstart = function () {
        return false;
      }; // запрет dragstart
    ...
    value: function onMouseDown(e) {
      var linkElem = e.target.closest('[data-element="logo__link"]');
...
module.exports = "http://localhost:3000/images/passenger.svg";
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"logo\"\n     data-component=\"logo\">\n  <a href=\"http://localhost:3000\"\n     class=\"logo__link\"\n     data-element=\"logo__link\"\n     "
    + ((stack1 = ((helper = (helper = helpers.tabindex || (depth0 != null ? depth0.tabindex : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"tabindex","hash":{},"data":data}) : helper))) != null ? stack1 : "")
    + ">\n    <img class=\"logo__img\"\n         data-element=\"logo__img\"\n         src=\""
    + container.escapeExpression(((helper = (helper = helpers.imgUrl || (depth0 != null ? depth0.imgUrl : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"imgUrl","hash":{},"data":data}) : helper)))
    + "\"\n         alt=\"logo\">\n  </a>\n</div>\n";
},"useData":true});
...
var _template = _interopRequireDefault(__webpack_require__(54));
...
/*#__PURE__*/
function (_BaseComponent) {
  _inherits(ButtonHeader, _BaseComponent);
  ...
  function ButtonHeader(_ref) {
    ...
    var el = _ref.el,
        value = _ref.value,
        publishRouteHash = _ref.publishRouteHash,
        componentName = _ref.componentName,
        tabindex = _ref.tabindex;

    _classCallCheck(this, ButtonHeader);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(ButtonHeader).call(this, {
      el: el
    }));
    _this.eventsPubSub = {};
    ...
    _this.setRouteHash = _router.default.setRouteHash.bind(_router.default, {
      routeHash: publishRouteHash
    });
...
// module
exports.push([module.i, ".button-header {\n  font-size: 60%;\n  color: #8c8c8c;\n  background-color: #f7f7f7;\n  padding: 0 10px; }\n  .button-header:hover {\n    color: #0a88e1;\n    background-color: white; }\n  .button-header_selected {\n    background-color: #ff7774;\n    color: white;\n    cursor: default;\n    transition: none; }\n  .button-header_selected:hover {\n    background-color: #ff7774;\n    color: white; }\n", ""]);
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div class=\"header\"\n     data-component=\"header\">\n  <div class=\"header__logo-container\"\n       data-element=\"header__logo-container\">\n  </div>\n  <div class=\"header__button-header-container\"\n       data-element=\"header__button-header-registration-container\">\n  </div>\n  <div class=\"header__button-header-container\"\n       data-element=\"header__button-header-login-container\">\n  </div>\n</div>\n";
},"useData":true});
...
// module
exports.push([module.i, ".header {\n  width: 100%;\n  height: 100%;\n  box-sizing: border-box;\n  background-color: #f7f7f7; }\n  .header__button-header-container {\n    float: right;\n    height: 100%; }\n  .header__logo-container {\n    height: 100%;\n    float: left;\n    margin-left: 20px; }\n\n@media only screen and (max-width: 420px) {\n  .header__logo-container {\n    margin-left: 10px; } }\n", ""]);
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div class=\"page\"\n     data-component=\"page\">\n  <header class=\"page__header-container\"\n          data-element=\"page__header-container\">\n  </header>\n  <main class=\"page__main-container\"\n        data-element=\"page__main-container\">\n    <div class=\"page__app-container hidden\"\n         data-element=\"page__app-container\">\n    </div>\n    <div class=\"page__base-container\"\n         data-element=\"page__base-container\">\n    </div>\n  </main>\n</div>\n";
},"useData":true});
